<header class="st-site-header st-style1 st-sticky-header">
  <div class="st-top-header d-none">
    <div class="container">
      <div class="st-top-header-in">
        <ul class="st-top-header-list">
          <li>
            ...
            <a href="#">disdikbud-ktt@gmail.com</a>
          </li>
          <li>
            ...
            <a href="#">+62 852 34567890</a>
          </li>
        </ul>
        <a href="#appointment" class="st-top-header-btn st-smooth-move">Dinas Pendidikan dan Kebudayaan - Kab. Tana
          Tidung</a>
      </div>
    </div>
  </div>
    ...
    <div class="container">
      <div class="st-main-header-in">
        <div class="st-main-header-left">
          <a class="st-site-branding" href="{{ route('home') }}"><img src="{{ url('assets/img/disdikbud-logo.svg') }}" alt="Nischinto" style="height: 44px;"></a>
        </div>
              ...
              <li class="menu-item-has-children"><a href="#blog">Berita</a>
                <ul>
                  @foreach (\Helper::berita_kategori() as $data)
                    <li><a href="{{ route('berita_kategori', $data->slug) }}">{{ $data->title }}</a></li>
                  @endforeach
                </ul>
              </li>
              <li class="menu-item-has-children"><a href="#gallery">Galeri</a>
                <ul>
                  <li><a href="{{ route('galley_berita') }}">Galeri Berita</a></li>
                  <li><a href="{{ route('galley_foto') }}">Galeri Foto</a></li>
                  <li><a href="{{ route('galley_video') }}">Galeri Video</a></li>
                </ul>
              </li>
            </ul>
          </div>
