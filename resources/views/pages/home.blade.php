...
@section('title', 'Dinas Pendidikan dan Kebudayaan - Kabupaten Tana Tidung')
...
@section('content')
  <div class="st-content">
      ...
      <div class="st-hero st-style1">
        <div class="container">
          <div class="st-hero-text">
            ...
            <div class="st-hero-subtitle">Jalinan masa lalu dan masa kini. Dukung cagar budaya untuk wariskan <br>
        ...
        <div class="row">
          <div class="col-lg-4">
            <div class="st-iconbox st-style1">
              ...
              <h2 class="st-iconbox-title">Cagar Budaya</h2>
          ...
          <div class="col-lg-4">
            <div class="st-iconbox st-style1">
              ...
              <h2 class="st-iconbox-title">Suku & Rumpun</h2>
              <div class="st-iconbox-text">Lorem ipsum dolor sit amet consectet adipis sed do eiusmod tempor inc ididunt
                utid labore.</div>
            </div>
            <div class="st-height-b0 st-height-lg-b30"></div>
          ...
          <div class="col-lg-4">
            <div class="st-iconbox st-style1">
              ...
              <h2 class="st-iconbox-title">Bahasa Daerah</h2>
              <div class="st-iconbox-text">Lorem ipsum dolor sit amet consectet adipis sed do eiusmod tempor inc ididunt
                utid labore.</div>
            </div>
            <div class="st-height-b0 st-height-lg-b30"></div>
    ...
    <!-- Section Kamus -->
    <section id="kamusdaerah" class="st-maps">
      <div class="st-height-b100 st-height-lg-b50"></div>
                ...
                <div class="row">
                  <div class="col">
                    ...
                    <div class="row">
                      <div class="col-lg-12">
                        <div class="st-form-field st-style1">
                          <input type="text" id="uname" name="uname" placeholder="Masukkan teks">
                        </div>
                      </div>
                      <div class="col-lg-12 text-center">
                        <button class="st-btn st-style1 st-color1 st-size-medium" type="submit" id="appointment-submit" name="submit">Translate</button>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-lg-12 mt-4">
                        <div class="translate-box st-form-field st-style1">
                          <textarea cols="30" rows="8" id="tranlate" name="tranlate" placeholder="Terjemahan" readonly></textarea>
                        </div>
                      </div>
                    </div>
                    <div class="row d-none">
                      <div class="col-lg-6">
                        <div class="st-form-field st-style1">
                          <textarea cols="30" rows="10" id="umsg" name="umsg" placeholder="Masukkan teks"></textarea>
                        </div>
                      </div>
                      <div class="col-lg-6">
                        <div class="st-form-field st-style1">
                          <textarea cols="30" rows="10" id="umsg" name="umsg" placeholder="Terjemahan"></textarea>
                        </div>
                      </div>
                    </div>
                  </div>
    ...
    <section id="cagarbudayamaps" class="st-maps">
      ...
      <div class="container">
        <div class="st-section-heading st-style1">
          <h2 class="st-section-heading-title">Peta Cagar Budaya</h2>
          <div class="st-seperator">
            <div class="st-seperator-left wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.2s"></div>
            <div class="st-seperator-center"><img src="{{ url('assets/img/logo.png') }}" alt="icon">
            </div>
    ...
    <section id="gallery" class="d-none">
      ...
      <div class="container">
        <div class="st-section-heading st-style1">
          <h2 class="st-section-heading-title">Galeri Kebudayaan</h2>
          <div class="st-seperator">
            <div class="st-seperator-left wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.2s"></div>
            <div class="st-seperator-center"><img src="{{ url('frontend/assets/img/icons/4.png') }}" alt="icon">
            </div>
            <div class="st-seperator-right wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.2s"></div>
          </div>
        ...
        <div class="st-portfolio-wrapper">
          <div class="st-isotop-filter st-style1 text-center">
            <ul class="st-mp0">
              ...
              <li><a href="#" data-filter=".cardiology">Cagar Budaya</a></li>
              <li><a href="#" data-filter=".neurology">Kegiatan</a></li>
            </ul>
          </div>
    ...
    <section class="d-none">
      ...
      <div class="container">
        <div class="st-section-heading st-style1">
          <h2 class="st-section-heading-title">Pesan dan Kesan</h2>
          <div class="st-seperator">
            <div class="st-seperator-left wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.2s"></div>
            <div class="st-seperator-center"><img src="{{ url('frontend/assets/img/icons/4.png') }}" alt="icon">
            </div>
    ...
    <!-- Start FAQ Section -->
    <section class="st-faq-wrap st-shape-wrap d-none">
      <div class="st-shape5">
            ...
            <div class="col-lg-4">
              <div class="st-post st-style3">
                <a href="{{ route('berita_detail', $item->slug) }}" class="st-post-thumb st-link-hover-wrap st-zoom">
                  <img class="st-zoom-in" src="{{ Storage::url('berita/images/thumb_' . $item->image) }}" alt="img">
