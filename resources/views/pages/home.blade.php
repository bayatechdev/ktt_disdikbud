...
@section('content')
  <div class="st-content">
              ...
              <div class="st-vertical-middle-in">
                <div class="st-text-block st-style1">
                  ...
                  <div class="st-text-block-avatar">
                    <div class="st-avatar-img"><img src="{{ url('frontend/assets/img/avatar1.png') }}" alt="avatar">
                    </div>
          ...
          <ul class="st-tab-links st-style1 st-mp0">
            ...
            <li class="st-tab-title">
              <a href="#X-ray" class="st-red-box">
                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                  ...
                  <g>
                    <path
                      d="M440,128H40c-4.418,0-8,3.582-8,8v208c0,4.418,3.582,8,8,8h52.52c6.941,39.326,3.217,79.793-10.784,117.192
            ...
            <li class="st-tab-title">
              <a href="#DentalCare" class="st-orange-box">
                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                  x="0px" y="0px" viewBox="0 0 480.335 480.335" xml:space="preserve">
                  <g>
                    <path
          ...
          <div class="tab-content">
            <div id="Crutches" class="st-tab active">
              <div class="st-imagebox st-style2">
                <div class="row">
                  <div class="col-lg-6">
                    <div class="st-imagebox-img"><img src="{{ url('frontend/assets/img/crutches.png') }}"
                        alt="service"></div>
                    <div class="st-height-b0 st-height-lg-b30"></div>
                  </div>
                  <div class="col-lg-6">
            ...
            <div id="X-ray" class="st-tab">
              <div class="st-imagebox st-style2">
                <div class="row">
                  <div class="col-lg-6">
                    <div class="st-imagebox-img"><img src="{{ url('frontend/assets/img/xray.png') }}" alt="service">
                    </div>
                    <div class="st-height-b0 st-height-lg-b30"></div>
                  </div>
                  <div class="col-lg-6">
            ...
            <div id="Pulmonary" class="st-tab">
              <div class="st-imagebox st-style2">
                <div class="row">
                  <div class="col-lg-6">
                    <div class="st-imagebox-img"><img src="{{ url('frontend/assets/img/pulmonary.png') }}"
                        alt="service"></div>
                    <div class="st-height-b0 st-height-lg-b30"></div>
                  </div>
                  <div class="col-lg-6">
            ...
            <div id="Cardiology" class="st-tab">
              <div class="st-imagebox st-style2">
                <div class="row">
                  <div class="col-lg-6">
                    <div class="st-imagebox-img"><img src="{{ url('frontend/assets/img/cardiology.png') }}"
                        alt="service"></div>
                    <div class="st-height-b0 st-height-lg-b30"></div>
                  </div>
                  <div class="col-lg-6">
            ...
            <div id="DentalCare" class="st-tab">
              <div class="st-imagebox st-style2">
                <div class="row">
                  <div class="col-lg-6">
                    <div class="st-imagebox-img"><img src="{{ url('frontend/assets/img/dental-care.png') }}"
                        alt="service"></div>
                    <div class="st-height-b0 st-height-lg-b30"></div>
                  </div>
                  <div class="col-lg-6">
            ...
            <div id="Neurology" class="st-tab">
              <div class="st-imagebox st-style2">
                <div class="row">
                  <div class="col-lg-6">
                    <div class="st-imagebox-img"><img src="{{ url('frontend/assets/img/neurology.png') }}"
                        alt="service"></div>
                    <div class="st-height-b0 st-height-lg-b30"></div>
                  </div>
                  <div class="col-lg-6">
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-10 offset-lg-1">
            <form method="POST" action="assets/php/appointment.php" class="st-appointment-form"
              id="appointment-form">
                ...
                <div class="st-member st-style1 st-zoom">
                  <div class="st-member-img">
                    ...
                    <div class="st-member-social-wrap">
                      <img src="{{ url('frontend/assets/img/shape/member-shape.svg') }}" alt="shape"
    ...
    <section class="st-before-after-section st-dynamic-bg st-bg"
      data-src="{{ url('frontend/assets/img/before-after-bg.jpg') }}">
      <div class="st-height-b120 st-height-lg-b80"></div>
      <div class="container">
        <div class="st-section-heading st-style1">
      ...
      <div class="container">
        ...
        <iframe src="https://www.google.com/maps/d/u/0/embed?mid=1Hdqh31kTY0xQeVNtQ5gMomBU3nskia4&ehbc=2E312F&noprof=1"
          ...
          <div class="col-xl-6 wow fadeInRight" data-wow-duration="0.8s" data-wow-delay="0.2s">
            <div class="st-video-block st-style1 st-zoom">
              <div class="st-video-block-img st-zoom-in st-dynamic-bg"
                data-src="{{ url('frontend/assets/img/video-block-img.jpg') }}">
              </div>
              ...
              <div class="slick-slide-in">
                <div class="st-pricing-table st-style1">
                  <div class="st-pricing-head">
                    ...
                    <img src="{{ url('frontend/assets/img/shape/price-shape.svg') }}" alt="shape"
    ...
    <section class="st-news-letter-section st-dynamic-bg st-bg"
      data-src="{{ url('frontend/assets/img/news-letter-bg.png') }}">
      <div class="container">
        <div class="st-section-heading st-style1">
    ...
    <section class="st-shape-wrap" id="contact">
      <div class="st-shape1"><img src="{{ url('frontend/assets/img/shape/contact-shape1.svg') }}" alt="shape1">
      </div>
      <div class="st-shape2"><img src="{{ url('frontend/assets/img/shape/contact-shape2.svg') }}" alt="shape2">
      </div>
      <div class="st-height-b120 st-height-lg-b80"></div>
      <div class="container">
        <div class="st-section-heading st-style1">
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-10 offset-lg-1">
            <div id="st-alert"></div>
            <form action="assets/php/mail.php" class="row st-contact-form st-type1" method="post"
              id="contact-form">
              <div class="col-lg-6">
                <div class="st-form-field st-style1">
                  <label>Full Name</label>
