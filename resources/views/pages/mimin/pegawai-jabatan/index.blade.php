...
@section('content')
  ...
  <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasAdd" aria-labelledby="offcanvasAddLabel">
    <div class="offcanvas-header">
      <h5 id="offcanvasAddLabel" class="offcanvas-title">Jabatan</h5>
    ...
    $(function() {
      ...
      if (data_table.length) {
        var dt_invoice = data_table.DataTable({
          ajax: 'jabatan_list', // JSON file to add data
          columns: [
          ...
          buttons: [{
            text: '<i class="bx bx-plus me-md-2"></i><span class="d-md-inline-block d-none">Jabatan</span>',
