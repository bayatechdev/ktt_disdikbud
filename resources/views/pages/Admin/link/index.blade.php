...
@section('content')
  ...
  @include('_partials._modals.modal-link-add')
@endsection
  ...
  <script>
    ...
    $(document).on('click', '.btn_edit', function(e) {
      ...
      if (token) {
        $.ajax({
          type: 'GET',
          url: "/dashboard/pages/link_edit/" + token,
          dataType: 'json',
          beforeSend: function() {
    ...
    $(function() {
      ...
      if (data_table.length) {
        var dt_invoice = data_table.DataTable({
          ajax: "{!! route('link_list') !!}", // JSON file to add data
          columns: [
