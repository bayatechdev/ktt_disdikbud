...
@section('content')
  <div class="title-with-button d-flex justify-content-between align-items-center">
    <h4 class="fw-bold py-3">
      <span class="text-muted fw-light">Pages / </span> Edit Halaman
    </h4>
    ...
    <form class="add-new pt-0" id="addForm" action="{{ route('halaman_statis_update', $item->token) }}" method="POST" role="form" enctype="multipart/form-data">
      ...
      <div class="card p-4">
        <div class="text-center mb-2">
          <h4 class="mb-2">Edit Halaman</h4>
          <p>Silahkan Edit Halaman</p>
        </div>
        <div class="row mt-2 px-4">
          <div class="row mb-3 g-1">
            <label class="col-sm-4 col-form-label" for="title">Judul Halaman<sup class="text-danger">*</sup></label>
            <div class="col-sm-8">
              <input type="text" id="title" name="title" class="form-control" autocomplete="off" placeholder="Judul Halaman" value="{{ $item->title }}" required />
            </div>
          </div>
          <div class="row mb-3 g-1">
          ...
          <div class="row mb-3 g-1">
            ...
            <div class="col-sm-8">
              <input type="text" id="order" name="order" class="form-control" autocomplete="off" placeholder="Urutan" value="{{ $item->order }}" />
            </div>
          </div>
          <div class="row mb-3 g-1">
