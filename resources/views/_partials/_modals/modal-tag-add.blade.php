  ...
  <div class="modal-dialog modal-dialog-scrollable  mx-auto" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="modalAddDataTitle">Tambah Tag</h5>
        ...
        <form class="add-new pt-0" id="addForm" action="" method="POST" role="form" enctype="multipart/form-data">
          ...
          <div class="row mt-2 px-1">
            <div class="row mb-2 g-1">
              <label class="col-sm-4 col-form-label text-md-end pd_r_10" for="title">Tag<sup class="text-danger">*</sup></label>
              <div class="col-sm-8">
                <input type="text" id="title" name="title" class="form-control" autocomplete="off" placeholder="Tag" required />
              </div>
            </div>
            <div class="row mb-2 g-1">
