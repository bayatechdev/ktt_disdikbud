  ...
  <div class="modal-dialog modal-lg modal-dialog-centered modal-simple">
    <div class="modal-content p-3 p-md-5">
      <div class="modal-body">
        ...
        <!-- <div class="card shadow-none border border-primary rounded" data-bs-target="#twoFactorAuthOne" data-bs-toggle="modal">
          <div class="card-body cursor-pointer">
            <div class="d-flex text-primary align-items-start">
              <i class="bx bx-cog bx-md me-3"></i>
              <div>
                <h4 class="mb-2 text-primary">Authenticator Apps</h4>
                <p class="mb-0">Get code from an app like Google Authenticator or Microsoft Authenticator.</p>
              </div>
            </div>
          </div>
        </div>
        <div class="card shadow-none border rounded mt-3" data-bs-target="#twoFactorAuthTwo" data-bs-toggle="modal">
          <div class="card-body cursor-pointer">
            <div class="d-flex align-items-start">
              <i class="bx bx-message bx-md me-3"></i>
              <div>
