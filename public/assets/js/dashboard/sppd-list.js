...
$(function () {
  ...
  if (dt_invoice_table.length) {
    var dt_invoice = dt_invoice_table.DataTable({
      ajax: assetsPath + 'json/dashboard/sppd-list.json', // JSON file to add data
      columns: [
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            return (
              ...
              '<a href="/sppd/sppd_preview" target="_BLANK" data-bs-toggle="tooltip" class="text-body btn_preview" data-bs-placement="top" title="Preview"><i class="bx bx-show mx-1"></i></a>' +
              '<div class="dropdown">' +
      ...
      buttons: [{
        text: '<span class="d-md-inline-block d-none">Tambah Surat</span>',
...
$(function () {
  ...
  var bsDatepickerFormat3 = $('#bs-datepicker-format3');
  if (bsDatepickerFormat3.length) {
    bsDatepickerFormat3.datepicker({
      todayHighlight: true,
      format: 'dd/mm/yyyy',
      orientation: isRtl ? 'auto right' : 'auto left'
    });
