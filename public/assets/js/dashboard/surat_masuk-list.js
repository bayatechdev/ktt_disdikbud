...
$(function () {
    ...
    var dt_invoice_table = $(".surat_masuk-table");
    ...
    if (dt_invoice_table.length) {
        var dt_invoice = dt_invoice_table.DataTable({
            ...
            ajax: assetsPath + "json/dashboard/surat_masuk-list.json", // JSON file to add data
            columns: [
                ...
                },
                {
                    ...
                    render: function (data, type, full, meta) {
                        ...
                        $row_output = $row_output +
                            '<div style="white-space: nowrap;"><span class="d-none">' +
                            moment($due_date).format("YYYYMMDD") +
                            "</span>" +
                            moment($due_date).format("DD MMM YYYY") + '</div>';
                ...
                },
                {
                    ...
                    render: function (data, type, full, meta) {
                        ...
                        if ($balance === 0) {
                            ...
                            return '<span class="badge bg-label-primary">Proses</span>';
                        }
                    },
                },
                {
                    ...
                    render: function (data, type, full, meta) {
                        return (
                            ...
                            // '<a href="javascript:;" data-bs-toggle="tooltip" class="text-body btn_disposisi" data-bs-placement="top" title="Disposisi"><i class="bx bx-send mx-1"></i></a>' +
                            ...
                            '<a href="/dashboard/surat_masuk/dispo_detail" class="dropdown-item">Disposisi</a>' +
                            '<a href="/dashboard/surat_masuk/dispo_detail" class="dropdown-item">Detail</a>' +
                            '<a href="' +
                            baseUrl +
            ...
            // buttons: [{
            //   text: '<i class="bx bx-plus me-md-2"></i><span class="d-md-inline-block d-none">Surat Masuk</span>',
                    ...
                    .every(function () {
                        ...
                        column
                            ...
                            .each(function (d, j) {
                                if (d == 0) {
                                    select.append(
                                        '<option value="Selesai" class="text-capitalize">Selesai</option>'
                                    );
                                } else {
                                    select.append(
                                        '<option value="Proses" class="text-capitalize">Proses</option>'
                                    );
                                }
                            });
                    });
...
$(function () {
    ...
    var bsDatepickerFormat2 = $("#bs-datepicker-format2");
    if (bsDatepickerFormat2.length) {
        bsDatepickerFormat2.datepicker({
            todayHighlight: true,
            format: "dd/mm/yyyy",
            orientation: isRtl ? "auto right" : "auto left",
        });
